...
namespace CARKGEZ.APP.ViewModels
{
    public class MainPageVM : INotifyPropertyChanged
    {
        ...
        {
            Colors = new List<string>() { "#107C10", "#FF5A5F", "#4267B2", "#4285F4", "#DB4437", "#F4B400", "#0F9D58", "#737373", "#FFB900", "#00A4EF", "#7FBA00", "#F25022" };
            List<string> Venues = new List<string>() { 
                ...
                "Asos",
                "Siktir Lan"
            };//tips from Google and Microsoft Colors
