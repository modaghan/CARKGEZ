...
using CARKGEZ.APP.Models;
using CARKGEZ.APP.ViewModels;
using Microsoft.Maui.Platform;
using SkiaSharp;
using SkiaSharp.Views.Maui;
using System.Diagnostics;

namespace CARKGEZ.APP
{
    public partial class MainPage : ContentPage
    {
        ...
        private void GetWinner()
        {
            ...
            priceBox.Text = viewModel.Prize.Venue;
        }
        ...
        void DrawRotatedWithMatrices(SKCanvas canvas, SKPath path, SKPaint fill, SKPaint outline, ChartData item, float degrees, int cx, int cy)
        {
            ...
            identity.PostConcat(translate);
            identity.PostConcat(rotate);
            identity.PostConcat(translate2);
        ...
        private void skiaView_PaintSurface(object sender, SkiaSharp.Views.Maui.SKPaintSurfaceEventArgs args)
        {
